...
Alajuela <- basecanton %>% filter(Canton == grupo1) %>% 
     dplyr::select(Year,Month,Precip_t1,Precip_t2,Precip_t3,Precip_t4,Precip_t5,Precip_t6,Nino34SSTA1,Nino34SSTA2,Nino34SSTA3,Nino34SSTA4,Nino34SSTA5,Nino34SSTA6,TNA1,TNA2,LSD1,LSD2,NDVI1,NDVI2,RRl1, RR) %>% arrange(Year,Month) %>% ungroup() %>% mutate(Month=as.numeric(Month))
...
p <- ggplot(data, aes(x = Mes, y = RR)) + geom_line(colour = "blue") +
  geom_line( aes(x = Mes, y = Resultados_Media), colour = "red") + ggtitle(grupo1[1])
...
load("base_cantones.RData")
# --------------------------
grupo1 <- c("La Cruz","Cañas","Liberia","Nicoya","Carrillo","SantaCruz","Puntarenas","Esparza","Montes de Oro")
Evaluacion3 = matrix(NA, ncol = 2, nrow = length(grupo1))
plot_list3 = list()
...
for(i in 1:length(grupo1)){
  ...
  grupo1 <- c("La Cruz","Cañas","Liberia","Nicoya","Carrillo","SantaCruz","Puntarenas","Esparza","Montes de Oro")
   Alajuela <- basecanton %>% filter(Canton == grupo1[i]) %>% 
...
p <- ggplot(data, aes(x = Mes, y = RR)) + geom_line(colour = "blue") +
  geom_line( aes(x = Mes, y = Resultados_Media), colour = "red") + ggtitle(grupo1[i])
...
Evaluacion3[i,1:2] = as.numeric(metricas(data))
...
load("base_cantones.RData")
# --------------------------
grupo2 <- c("Limon","Matina","Perez Zeledón","Talamanca","Pococí","Guacimo","Siquirres","Sarapiquí","Turrialba")
Evaluacion3_G2 = matrix(NA, ncol = 2, nrow = length(grupo2))
plot_list3_G2 = list()
...
for(i in 1:length(grupo2)){
  ...
  grupo2 <- c("La Cruz","Cañas","Liberia","Nicoya","Carrillo","SantaCruz","Puntarenas","Esparza","Montes de Oro")
   Alajuela <- basecanton %>% filter(Canton == grupo2[i]) %>% 
     dplyr::select(Year,Month,Nino12SSTA, Nino3SSTA, Nino4SSTA,Nino34SSTA,Nino34SSTA1, Nino34SSTA2, Nino34SSTA3, Nino34SSTA4, Nino34SSTA5, Nino34SSTA6, TNA, TNA1,TNA2, EVI, NDVI, NDVI1, NDVI2, NDWI,       LSD, LSD1, LSD2, LSN, Precip_t, Precip_t1, Precip_t2, Precip_t3, Precip_t4, Precip_t5, Precip_t6, RRl1, RR) %>% 
       arrange(Year,Month) %>% ungroup() %>% mutate(Month=as.numeric(Month))
...
p <- ggplot(data, aes(x = Mes, y = RR)) + geom_line(colour = "blue") +
  geom_line( aes(x = Mes, y = Resultados_Media), colour = "red") + ggtitle(grupo2[i])
...
Evaluacion3_G2[i,1:2] = as.numeric(metricas(data))
...
load("base_cantones.RData")
# --------------------------
grupo3 <- c("Desamparados","Alajuelita","San Jose","Santa Ana","Alajuela","Atenas")   
Evaluacion3_G3 = matrix(NA, ncol = 2, nrow = length(grupo3))
plot_list3_G3 = list()

plot_normal = list()

for(i in 1:length(grupo3)){
  
  #grupo3 <- c("La Cruz","Cañas","Liberia","Nicoya","Carrillo","SantaCruz","Puntarenas","Esparza","Montes de Oro")
   Alajuela <- basecanton %>% filter(Canton == grupo3[i]) %>% 
     dplyr::select(Year,Month,Nino12SSTA, Nino3SSTA, Nino4SSTA,Nino34SSTA,Nino34SSTA1, Nino34SSTA2, Nino34SSTA3, Nino34SSTA4, Nino34SSTA5, Nino34SSTA6, TNA, TNA1,TNA2, EVI, NDVI, NDVI1, NDVI2, NDWI,       LSD, LSD1, LSD2, LSN, Precip_t, Precip_t1, Precip_t2, Precip_t3, Precip_t4, Precip_t5, Precip_t6, RRl1, RR) %>% 
       arrange(Year,Month) %>% ungroup() %>% mutate(Month=as.numeric(Month))
...
p <- ggplot(data, aes(x = Mes, y = RR)) + geom_line(colour = "blue") +
  geom_line( aes(x = Mes, y = Resultados_Media), colour = "red") + ggtitle(grupo3[i])
...
Evaluacion3_G3[i,1:2] = as.numeric(metricas(data))
...
for(i in 1:length(grupo4)){
  ...
  grupo4 <- c("La Cruz","Cañas","Liberia","Nicoya","Carrillo","SantaCruz","Puntarenas","Esparza","Montes de Oro")
