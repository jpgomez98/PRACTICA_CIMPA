...
metricas <- function(tabla){
  ...
  NIS_95 <- mean((tabla$u_overall_upper-tabla$u_overall_lower)+
                   (2/0.05)*(tabla$u_overall_lower-Alajuela$RR)*(Alajuela$RR<tabla$u_overall_lower)+
                   (2/0.05)*(Alajuela$RR-tabla$u_overall_upper)*(Alajuela$RR>tabla$u_overall_upper))/mean(Alajuela$RR)
