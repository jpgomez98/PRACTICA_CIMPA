...
basecanton = basecanton  %>% 
  ...
  dplyr::select(Canton, Year,Month,Precip_t1,Precip_t2,Precip_t3,Precip_t4,Precip_t5,Precip_t6,Nino34SSTA1,Nino34SSTA2,Nino34SSTA3,Nino34SSTA4,Nino34SSTA5,Nino34SSTA6,TNA1,TNA2,LSD1,LSD2,NDVI1,NDVI2,RRl1, RR) %>% 
...
basecanton2 = basecanton2[,-ncol(basecanton2)]
...
for (i in 1:length(Cantones)) {
  ...
  X_all = as.matrix(X_all[,-c(1,ncol(basecanton2))])
