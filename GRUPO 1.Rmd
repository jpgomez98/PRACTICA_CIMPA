...
RR~R1+R2+P1+P2+N1+N2+T1+T2+L1+L2+NV1+NV2
Precip_t1,Precip_t2,Precip_t3,Precip_t4,Precip_t5,Precip_t6,Nino34SSTA1,Nino34SSTA2,Nino34SSTA3,Nino34SSTA4,Nino34SSTA5,Nino34SSTA6,TNA1,TNA2,LSD1,LSD2,NDVI1,NDVI2
```{r}
a <- c("Year","Month","Nino34SSTA","Nino34SSTA1", "Nino34SSTA2", "Nino34SSTA3", "Nino34SSTA4", "Nino34SSTA5", "Nino34SSTA6", "TNA", "TNA1","TNA2", "EVI", "NDVI", "NDVI1", "NDVI2", "NDWI","LSD", "LSD1", "LSD2", "LSN", "Precip_t", "Precip_t1", "Precip_t2", "Precip_t3", "Precip_t4", "Precip_t5", "Precip_t6", "RRl1", "RR")
length(a)
```
...
p <- ggplot(data, aes(x = Mes, y = RR)) + geom_line(colour = "blue") +
  geom_line( aes(x = Mes, y = Resultados_Media), colour = "red") + 
  geom_ribbon(aes(ymin=LI1,ymax=LS2), alpha=0.2, fill = "red") +
  xlim(1,3)+ggtitle(grupo1[i])
...
rownames(Evaluacion3) <- grupo1
colnames(Evaluacion3) <- c("NRMSE","NIS_95")
Evaluacion3
```
